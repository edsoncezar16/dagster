...
from dagster_tests.definitions_tests.auto_materialize_tests.scenarios.active_run_scenarios import (
    active_run_scenarios,
)
from dagster_tests.definitions_tests.auto_materialize_tests.scenarios.auto_materialize_policy_scenarios import (
    auto_materialize_policy_scenarios,
)
from dagster_tests.definitions_tests.auto_materialize_tests.scenarios.auto_observe_scenarios import (
    auto_observe_scenarios,
)
from dagster_tests.definitions_tests.auto_materialize_tests.scenarios.basic_scenarios import (
    basic_scenarios,
)
from dagster_tests.definitions_tests.auto_materialize_tests.scenarios.definition_change_scenarios import (
...
from dagster_tests.definitions_tests.auto_materialize_tests.scenarios.multi_code_location_scenarios import (
    multi_code_location_scenarios,
)
from dagster_tests.definitions_tests.auto_materialize_tests.scenarios.observable_source_asset_scenarios import (
...
from dagster_tests.definitions_tests.auto_materialize_tests.scenarios.version_scenarios import (
    version_scenarios,
)
