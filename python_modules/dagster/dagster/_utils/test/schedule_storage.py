...
class TestScheduleStorage:
    ...
    def test_auto_materialize_asset_evaluations(self, storage) -> None:
            ...
            storage.add_auto_materialize_asset_evaluations(
                ...
                asset_evaluations=[
                    AutomationConditionEvaluation(
                        ...
                        true_subset=AssetSubset(key=AssetKey("asset_one"), value=False),
                        candidate_subset=AssetSubset(key=AssetKey("asset_one"), value=False),
                        start_timestamp=0,
                        end_timestamp=1,
                    ...
                    AutomationConditionEvaluation(
                        condition_snapshot=condition_snapshot,
                        true_subset=AssetSubset(key=AssetKey("asset_two"), value=True),
                        candidate_subset=AssetSubset(key=AssetKey("asset_two"), value=True),
                        start_timestamp=0,
                        end_timestamp=1,
                        subsets_with_metadata=[
                            AssetSubsetWithMetadata(
                                subset=AssetSubset(key=AssetKey("asset_two"), value=True),
        ...
        storage.add_auto_materialize_asset_evaluations(
            ...
            asset_evaluations=[
                AutomationConditionEvaluation(
                    ...
                    start_timestamp=0,
                    end_timestamp=1,
                    true_subset=AssetSubset(key=AssetKey("asset_one"), value=True),
                    candidate_subset=AssetSubset(key=AssetKey("asset_one"), value=True),
                    subsets_with_metadata=[],
                    child_evaluations=[],
                ).with_run_ids(set()),
            ],
        ...
        eval_asset_three = AutomationConditionEvaluation(
            ...
            start_timestamp=0,
            end_timestamp=1,
            true_subset=AssetSubset(key=AssetKey("asset_three"), value=True),
            candidate_subset=AssetSubset(key=AssetKey("asset_three"), value=True),
            subsets_with_metadata=[],
            child_evaluations=[],
        ).with_run_ids(set())
    ...
    def test_auto_materialize_asset_evaluations_with_partitions(self, storage) -> None:
        ...
        asset_subset = AssetSubset(key=AssetKey("asset_two"), value=subset)
